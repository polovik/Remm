...
ARM_LDFLAGS=-lpthread -ldl -lstdc++ -L$(ARM_PJ)/pjlib/lib -L$(ARM_PJ)/pjlib-util/lib -L$(ARM_PJ)/pjnath/lib -L../OpenCV-2.3.1/raspberry/lib
ARM_LIBS=-lpjnath-$(ARM_ARCH) -lpjlib-util-$(ARM_ARCH) -lpj-$(ARM_ARCH) -lm -lnsl -lrt -lpthread -lopencv_core -lopencv_highgui
ARM_DEFINES=-DPJ_IS_BIG_ENDIAN=0 -DPJ_IS_LITTLE_ENDIAN=1
ARM_CFLAGS=-g -Wall $(ARM_DEFINES) -I$(ARM_PJ)/pjlib/include -I$(ARM_PJ)/pjnath/include -I$(ARM_PJ)/pjlib-util/include -I../OpenCV-2.3.1/modules/core/include -I../OpenCV-2.3.1/modules/highgui/include
...
all:
	...
	$(ARM_CC) $(SERVER)/http.o $(SERVER)/connection.o $(SERVER)/camera.o $(SERVER)/main.o -o $(SERVER)/$(SERVER) $(ARM_LDFLAGS) $(ARM_LIBS)
	echo ***HOST***
